<template>
  <section class="modlude">
      ...
      <el-form :inline="true" class="gridContt">
        <el-form :inline="true">
          <el-form-item size="small" label="账号">
            <el-input placeholder="请输入账号" v-model="checkInfor.nativePlace" size='small'></el-input>
          </el-form-item>
          <el-form-item size="small" label="姓名">
            <el-input placeholder="请输入姓名" v-model="checkInfor.nativePlac1e" size='small'></el-input>
          </el-form-item>
          <el-form-item size="small" label="手机">
            <el-input placeholder="请输入手机" v-model="checkInfor.nativePlace2" size='small'></el-input>
          </el-form-item>
          <el-form-item size="small" label="身份证">
            <el-input placeholder="请输入身份证" v-model="checkInfor.nativePlace3" size='small'></el-input>
          </el-form-item>
          <el-form-item size="small" label="部门">
            <el-input placeholder="请输入部门" v-model="checkInfor.nativePlac6e" size='small'></el-input>
          </el-form-item>
    ...
    <el-table :data="inforList" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="sex" label="操作时间">
			</el-table-column>
			<el-table-column prop="duty" label="操作菜单">
			</el-table-column>
			<el-table-column prop="department" label="操作类型">
			</el-table-column>
			<el-table-column prop="isSplite" label="结果">
			</el-table-column>
			<el-table-column prop="temperature" label="操作详情">
			</el-table-column>
  ...
  data(){
    return{
      ...
      inforList:[
        ...
        {
          name:'adminky',
          sex:'2020.06.12 12:22:10',
          duty:'初始化设备',
          department:'修改',
          isSplite:'成功',
          temperature:'修改设备【打卡机】',
          health:'30',
          isCross:'3号仓库',
          isContact:'未审核',
          isContactt:"审核通过"
